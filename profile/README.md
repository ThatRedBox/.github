...
#### Features
- **A reliable, robust computer system** ready to be build into your creations. Raspberry Pi equipped with the Edgeberry IoT ecosystem provides a solid foundation for a wide range of ideas.
